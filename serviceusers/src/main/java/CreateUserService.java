...
public class CreateUserService {
    ...
    private void insertNewUser(String email) throws SQLException {
        var insert = conection.prepareStatement("insert into Users (uuid, email) values (?,?)");
    ...
    private boolean isNewUser(String email) throws SQLException {
        var exists = conection.prepareStatement("select uuid from Users  where email = ?  limit 1");
